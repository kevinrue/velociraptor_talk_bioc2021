...
Use gene selection, normalization and dimension reduction from <i class="fab fa-python"></i> [scVelo](https://pypi.org/project/scvelo/), or customize each step in R for full compatibility with the rest of the workflow.
